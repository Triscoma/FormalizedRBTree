...
Proof.
  intros a b. rewrite <- app_comm_cons. apply perm_skip. rewrite app_nil_r. rewrite app_comm_cons. 
  apply Permutation_app_comm with (l := 6::a) (l' := b).
Qed.
...
Example not_a_permutation:
  ~ Permutation [1;1] [1;2].
Proof.
  unfold not. intro H. apply Permutation_cons_inv in H. apply Permutation_length_1_inv in H. discriminate H.
Qed.
(** [] *)
...
Proof.
  intros A f. intros al bl H. induction H.
  - auto.
  - intro. inv H0. apply IHPermutation in H4. apply Forall_cons ; assumption.
  - intro. inv H. inv H3.  
